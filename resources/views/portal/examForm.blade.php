          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{ url('portal/examFormSubmit') }}" class="databaseOperation">
                @csrf
                <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="from-group">
                            ...
                            <input type="text" name="mobile_no" required="required" placeholder="Mobile No." class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="from-group">
